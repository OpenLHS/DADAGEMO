 ...
 * [DADAGEMO.yml](DADAGEMO.yml)
     * Determines how your purl.obolibrary.org/obo/DADAGEMO/ redirects will be handled
     ...
     * Paste in the contents of [DADAGEMO.yml](DADAGEMO.yml)
 ...
 * [DADAGEMO.md](DADAGEMO.md)
     ...
     * Paste in the contents of [DADAGEMO.md](DADAGEMO.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
